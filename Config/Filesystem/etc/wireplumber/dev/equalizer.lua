...
local args = {
  ...
  ["adapter.auto-port-config"] = Json.Object { monitor = true },
}
...
args["filter.graph"] = Json.Object {
  nodes = Json.Array {
    Json.Object {
        ...
        name  = "eq_band_1",
        label = "bq_lowshelf",
        control = Json.Object { Freq = 100.0, Q = 1.0, Gain = 0.5 },
    },
    Json.Object {
        type  = "builtin",
        name  = "eq_band_2",
        label = "bq_peaking",
        control = Json.Object { Freq = 100.0, Q = 1.0, Gain = 2.0 },
    },
    Json.Object {
        type  = "builtin",
        name  = "eq_band_3",
        label = "bq_peaking",
        control = Json.Object { Freq = 500.0, Q = 1.0, Gain = 2.0 },
    },
    Json.Object {
        type  = "builtin",
        name  = "eq_band_4",
